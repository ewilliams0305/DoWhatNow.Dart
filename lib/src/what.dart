...
abstract class What<TError> {
  ...
  /// Displays the Error Message contined in the [What]
  @override
...
class WhatEmpty<TValue> extends What<String> {
  /// Creates a new instance of an Empty [WhatEmpty]
...
class WhatMessage extends What<String> {
  /// Creates a new instance of the [WhatMessage]
...
class WhatObject extends What<Object> {
  /// Creates a new instance of the [WhatObject] containing an error [Object]
...
class WhatException extends What<Exception> {
  /// Creates a new instance of the [WhatException] containing an error [Exception]
...
extension WhatErrorsExtension on List<What> {
  ...
  String displayErrors() =>
      isEmpty ? '' : map((error) => error.toString()).join(' | ');
